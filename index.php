...
<!-- [START] MV-->
<section id="top-mv" class="section__mv block" style="background-image: url(<?php echo get_template_directory_uri() ?>/images/top_bg2.png);">
...
<section id="top-activities" class="section__news block" chunk>
  <div class="two_column-inner">
    <h2 class="section__ttl" bg-hidden bg-hidden-bl>Activities</h2>
