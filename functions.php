...
{
	//  WoWJs CDN
	wp_enqueue_style('animatecss', 'https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css', array(), '4.1.1', 'all');
	...
	// INDEX.CSS
	// wp_enqueue_style('indexcss', get_template_directory_uri() . '/css/index.min.css', array('reset'));
	// 編集用CSS
	...
	wp_enqueue_style('pages', get_template_directory_uri() . '/css/pages.css', array('templates'));
	...
	wp_enqueue_script('skill', get_template_directory_uri() . '/js/skill.bars.jquery.js', array());
}
...
add_action(
	...
	function ($post_id) {
		//nonceを確認
		if (
			isset($_POST['noncename-css-internal']) == false
